...
<style>
    ...
    .sb-name {
        ...
        color: #2e1a0e; text-align: center; margin-bottom: 2px;
    }
    ...
    .nav-btn {
        ...
        font-size: 0.85rem; font-weight: 500; color: #7a5c3e;
    ...
    .card-title {
        ...
        color: #2e1a0e; margin-bottom: 20px;
    }
    ...
    .f-lbl {
        ...
        letter-spacing: .09em; text-transform: uppercase; color: #a07858;
    }

    .f-inp {
        width: 100%; padding: 12px 15px;
        border: 1px solid #e2d0bc; border-radius: 12px;
        background: #f5ede3; font-family: 'DM Sans', sans-serif;
        font-size: 14px; color: #3e2712; outline: none;
    ...
    /* ── Buttons ── */
    .btn-primary {
        background: #c4693f; color: #fff; border: none;
    ...
    .btn-ghost {
        background: #f5ede3; color: #8b5e3c; border: none;
    ...
    .btn-sm {
        ...
        border: 1px solid #e8ddd0; background: #fffdf9;
        font-size: 13px; font-weight: 500; color: #7a5c3e;
    ...
    .info-note {
        ...
        font-size: 13px; color: #7d6b60; margin-top: 16px;
    }

    /* ── Address card ── */
    .address-card {
        border: 1px solid #e8ddd0; border-radius: 14px; padding: 16px;
        background: #fffdf9; margin-bottom: 18px;
    }
    ...
    .modal-overlay {
        ...
        background: rgba(46,26,14,.45); z-index: 9999;
        align-items: center; justify-content: center; padding: 20px;
    }
    .modal-box {
        background: #fffdf9; width: 100%; max-width: 620px;
    ...
    .modal-head {
        padding: 24px 28px; border-bottom: 1px solid #e8ddd0;
    ...
    .modal-close {
        ...
        border: none; background: #f0e4d0; cursor: pointer;
        font-size: 16px; color: #7a5c3e; transition: .15s;
    }
    ...
    .detail-chip {
        background: #f5ede3; border-radius: 14px; padding: 16px;
    }
...
<div class="pf-grid">
    ...
    <button class="nav-btn" onclick="showPanel('withdraw',this)">
    ...
    <div>
        ...
        <div id="panel-withdraw" class="panel">
            ...
            <div class="withdraw-stat">
                <div class="ws-lbl">Total Commission Earned</div>
                <div class="ws-val">₱{{ number_format($commission, 2) }}</div>
                <div class="ws-sub">Based on total commissions across all orders</div>
            </div>

            <div class="card">
                <div class="card-title">Withdraw Commission</div>

                @if(session('status') === 'withdrawn')
                    <div class="alert-success">✓ Withdrawal of ₱{{ session('withdrawn_amount') }} was successful.</div>
                @endif
...
">
    ...
    <p style="
        ...
        line-height:1.6;
    ">
        Choose your preferred withdrawal method before processing your commission withdrawal.
    </p>

</div>

<a href="{{ route('withdraw.choose') }}"
   class="btn-primary"
   style="
        width:100%;
        display:flex;
   ...
   ">
    Continue Withdrawal →
                ...
                @else
                    ...
                    <div style="text-align:center;padding:30px 0;color:#9d7d6a;font-size:14px;">
